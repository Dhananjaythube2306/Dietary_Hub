...
.user {
  ...
  background: url("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQO_QYrd2Kri1yy0n_UNMaaDY1PSyM-2d4sPQ&usqp=CAU") no-repeat center;
}
          ...
          <div class="user_options-forms" id="user_options-forms">
            ...
            <div class="user_forms-signup">
              ...
              <form action="registor" method="Post" class="forms_form">
                <fieldset class="forms_fieldset">
                  <div class="forms_field">
                    <input type="text" name="username" placeholder="User Name" class="forms_field-input" required />
                  </div>
                  <div class="forms_field">
